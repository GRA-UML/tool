 ...
 *
 */
package org.ijis.gra.uml.search.ui;
...
import static org.ijis.gra.uml.merge.NamespaceMergeUtil.mapEquivalents;
import static org.ijis.gra.uml.papyrus.preferences.PreferenceConstants.P_SYNC_CLASS_DIAGRAMS_WITH_UML;
import static org.ijis.gra.uml.papyrus.util.PapyrusExt.delete;
import static org.ijis.gra.uml.papyrus.util.PapyrusExt.getTheEditingDomain;
import static org.ijis.gra.uml.papyrus.util.PapyrusExt.getThePageManager;
import static org.ijis.gra.uml.util.CollectionExt.minus;
import static org.ijis.gra.uml.util.NIEMUmlExt.getReferenceLibrarySubsets;
import static org.ijis.gra.uml.util.NIEMUmlExt.isPIM;
import static org.ijis.gra.uml.util.UMLExt.collectOwnedElementsAndRelationships;
...
import org.ijis.gra.uml.merge.NamespaceMerger;
import org.ijis.gra.uml.merge.ReferenceCollector;
                    ...
                    try {
                        ...
                        final RecordingCommand theMergeCommand = new RecordingCommand(theEditingDomain, Activator.INSTANCE
                            ...
                            private void doAdd() {
                                ...
                                if (org.ijis.gra.uml.papyrus.Activator.getPlugin().getPreferenceStore()
