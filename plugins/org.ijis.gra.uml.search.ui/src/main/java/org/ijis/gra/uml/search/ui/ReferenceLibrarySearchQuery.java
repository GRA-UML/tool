...
import org.ijis.gra.uml.search.Aggregator;
import org.ijis.gra.uml.search.Criteria;
...
public class ReferenceLibrarySearchQuery implements ISearchQuery {
    ...
    public IStatus run(final IProgressMonitor monitor) throws OperationCanceledException {
        ...
        final int libraryCount = org.ijis.gra.uml.library.Activator.LIBRARY_COUNT;
