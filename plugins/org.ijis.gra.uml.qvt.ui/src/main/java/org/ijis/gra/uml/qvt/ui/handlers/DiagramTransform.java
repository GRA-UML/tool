...
//import static org.ijis.gra.uml.papyrus.util.DiagramExt.getTheCorrespondingUmlFile;
...
//import org.ijis.gra.uml.papyrus.util.DiagramFilter;
...
public abstract class DiagramTransform extends Transform {
    ...
    protected final IResource askForResource(final Shell theShell) {
    	/* tjd TODO: something other than papyrus here
