...
final class GraSppModel2sddDelegate 
	//extends TransformDelegate // can not override transform
	extends TransformM2tDelegate
	{


    protected GraSppModel2sddDelegate(final URI selection) {
        super(selection, 
        		new SDDAction( Activator.INSTANCE.getString("_UI_GRAmpdmodel2sdd_Command_name"),  Activator.INSTANCE.getString("_UI_GRAmpdmodel2sdd_Command_name")), 
        		Activator.INSTANCE.getString("_UI_GRAmpdmodel2sdd_Command_name"));
    }
