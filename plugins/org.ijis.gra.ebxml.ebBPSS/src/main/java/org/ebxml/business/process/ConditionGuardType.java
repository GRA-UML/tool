...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Condition Guard Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.ebxml.business.process.ProcessPackage#getConditionGuardType()
 * @model extendedMetaData="name='conditionGuard_._type'"
 * @generated
 */
public enum ConditionGuardType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Condition Guard Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ConditionGuardType[] VALUES_ARRAY =
		new ConditionGuardType[] {
			SUCCESS,
			BUSINESS_FAILURE,
			TECHNICAL_FAILURE,
			ANY_FAILURE,
	...
	/**
	 * A public read-only list of all the '<em><b>Condition Guard Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ConditionGuardType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Condition Guard Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConditionGuardType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ConditionGuardType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Condition Guard Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConditionGuardType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ConditionGuardType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Condition Guard Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConditionGuardType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ConditionGuardType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
