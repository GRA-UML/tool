 ...
 * <ul>
 *   <li>{@link org.ebxml.business.process.impl.ForkTypeImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.ebxml.business.process.impl.ForkTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.ebxml.business.process.impl.ForkTypeImpl#getNameID <em>Name ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ForkTypeImpl extends MinimalEObjectImpl.Container implements ForkType {
	/**
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.FORK_TYPE;
	}
	...
	public EList<DocumentationType> getDocumentation() {
		if (documentation == null) {
			documentation = new EObjectContainmentEList<DocumentationType>(DocumentationType.class, this, ProcessPackage.FORK_TYPE__DOCUMENTATION);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.FORK_TYPE__NAME, oldName, name));
	}
	...
	public void setNameID(String newNameID) {
		...
		nameID = newNameID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.FORK_TYPE__NAME_ID, oldNameID, nameID));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.FORK_TYPE__DOCUMENTATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ProcessPackage.FORK_TYPE__NAME:
				return getName();
			case ProcessPackage.FORK_TYPE__NAME_ID:
				return getNameID();
		}
