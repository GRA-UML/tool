 ...
 * <ul>
 *   <li>{@link org.ebxml.business.process.impl.FailureTypeImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.ebxml.business.process.impl.FailureTypeImpl#getConditionExpression <em>Condition Expression</em>}</li>
 *   <li>{@link org.ebxml.business.process.impl.FailureTypeImpl#getConditionGuard <em>Condition Guard</em>}</li>
 *   <li>{@link org.ebxml.business.process.impl.FailureTypeImpl#getFromBusinessState <em>From Business State</em>}</li>
 *   <li>{@link org.ebxml.business.process.impl.FailureTypeImpl#getFromBusinessStateIDRef <em>From Business State ID Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FailureTypeImpl extends MinimalEObjectImpl.Container implements FailureType {
	 ...
	 * @ordered
	 */
	protected static final ConditionGuardType1 CONDITION_GUARD_EDEFAULT = ConditionGuardType1.SUCCESS;
	 ...
	 * @ordered
	 */
	protected ConditionGuardType1 conditionGuard = CONDITION_GUARD_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.FAILURE_TYPE;
	}
	...
	public EList<DocumentationType> getDocumentation() {
		if (documentation == null) {
			documentation = new EObjectContainmentEList<DocumentationType>(DocumentationType.class, this, ProcessPackage.FAILURE_TYPE__DOCUMENTATION);
		}
	...
	public NotificationChain basicSetConditionExpression(ConditionExpressionType newConditionExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.FAILURE_TYPE__CONDITION_EXPRESSION, oldConditionExpression, newConditionExpression);
	...
	public void setConditionExpression(ConditionExpressionType newConditionExpression) {
		if (newConditionExpression != conditionExpression) {
			...
			if (conditionExpression != null)
				msgs = ((InternalEObject)conditionExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.FAILURE_TYPE__CONDITION_EXPRESSION, null, msgs);
			if (newConditionExpression != null)
				msgs = ((InternalEObject)newConditionExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.FAILURE_TYPE__CONDITION_EXPRESSION, null, msgs);
			msgs = basicSetConditionExpression(newConditionExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.FAILURE_TYPE__CONDITION_EXPRESSION, newConditionExpression, newConditionExpression));
	}
	 ...
	 * @generated
	 */
	public ConditionGuardType1 getConditionGuard() {
	 ...
	 * @generated
	 */
	public void setConditionGuard(ConditionGuardType1 newConditionGuard) {
		ConditionGuardType1 oldConditionGuard = conditionGuard;
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.FAILURE_TYPE__CONDITION_GUARD, oldConditionGuard, conditionGuard, !oldConditionGuardESet));
	}
	...
	public void unsetConditionGuard() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ProcessPackage.FAILURE_TYPE__CONDITION_GUARD, oldConditionGuard, CONDITION_GUARD_EDEFAULT, oldConditionGuardESet));
	}
	...
	public void setFromBusinessState(String newFromBusinessState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.FAILURE_TYPE__FROM_BUSINESS_STATE, oldFromBusinessState, fromBusinessState));
	}
	...
	public void setFromBusinessStateIDRef(String newFromBusinessStateIDRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.FAILURE_TYPE__FROM_BUSINESS_STATE_ID_REF, oldFromBusinessStateIDRef, fromBusinessStateIDRef));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.FAILURE_TYPE__DOCUMENTATION:
				return ((InternalEList<?>)getDocumentation()).basicRemove(otherEnd, msgs);
			case ProcessPackage.FAILURE_TYPE__CONDITION_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ProcessPackage.FAILURE_TYPE__CONDITION_GUARD:
				return getConditionGuard();
			case ProcessPackage.FAILURE_TYPE__FROM_BUSINESS_STATE:
				return getFromBusinessState();
			case ProcessPackage.FAILURE_TYPE__FROM_BUSINESS_STATE_ID_REF:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ProcessPackage.FAILURE_TYPE__CONDITION_EXPRESSION:
				...
				return;
			case ProcessPackage.FAILURE_TYPE__CONDITION_GUARD:
				setConditionGuard((ConditionGuardType1)newValue);
				return;
			case ProcessPackage.FAILURE_TYPE__FROM_BUSINESS_STATE:
