...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Condition Guard Type1</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.ebxml.business.process.ProcessPackage#getConditionGuardType1()
 * @model extendedMetaData="name='conditionGuard_._1_._type'"
 * @generated
 */
public enum ConditionGuardType1 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Condition Guard Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ConditionGuardType1[] VALUES_ARRAY =
		new ConditionGuardType1[] {
			SUCCESS,
			BUSINESS_FAILURE,
			TECHNICAL_FAILURE,
			ANY_FAILURE,
	...
	/**
	 * A public read-only list of all the '<em><b>Condition Guard Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ConditionGuardType1> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Condition Guard Type1</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConditionGuardType1 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ConditionGuardType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Condition Guard Type1</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConditionGuardType1 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ConditionGuardType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Condition Guard Type1</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConditionGuardType1 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ConditionGuardType1(int value, String name, String literal) {
		this.value = value;
		this.name = name;
