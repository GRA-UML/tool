...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Signature Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.w3._2000._09.xmldsig.impl.SignatureTypeImpl#getSignedInfo <em>Signed Info</em>}</li>
 *   <li>{@link org.w3._2000._09.xmldsig.impl.SignatureTypeImpl#getSignatureValue <em>Signature Value</em>}</li>
 ...
 * @generated
 */
public class SignatureTypeImpl extends MinimalEObjectImpl.Container implements SignatureType {
	/**
	...
	/**
	 * The cached value of the '{@link #getSignatureValue() <em>Signature Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSignatureValue()
	 * @generated
	 * @ordered
	 */
	protected byte[] signatureValue = SIGNATURE_VALUE_EDEFAULT;
	...
	public NotificationChain basicSetSignedInfo(SignedInfoType newSignedInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmldsigPackage.SIGNATURE_TYPE__SIGNED_INFO, oldSignedInfo, newSignedInfo);
	...
	public void setSignedInfo(SignedInfoType newSignedInfo) {
		if (newSignedInfo != signedInfo) {
			...
			if (signedInfo != null)
				msgs = ((InternalEObject)signedInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmldsigPackage.SIGNATURE_TYPE__SIGNED_INFO, null, msgs);
			if (newSignedInfo != null)
				msgs = ((InternalEObject)newSignedInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XmldsigPackage.SIGNATURE_TYPE__SIGNED_INFO, null, msgs);
			msgs = basicSetSignedInfo(newSignedInfo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.SIGNATURE_TYPE__SIGNED_INFO, newSignedInfo, newSignedInfo));
	}
	...
	public void setSignatureValue(byte[] newSignatureValue) {
		byte[] oldSignatureValue = signatureValue;
		signatureValue = newSignatureValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.SIGNATURE_TYPE__SIGNATURE_VALUE, oldSignatureValue, signatureValue));
	}
	...
	public NotificationChain basicSetKeyInfo(KeyInfoType newKeyInfo, NotificationChain msgs) {
		...
		keyInfo = newKeyInfo;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmldsigPackage.SIGNATURE_TYPE__KEY_INFO, oldKeyInfo, newKeyInfo);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setKeyInfo(KeyInfoType newKeyInfo) {
		if (newKeyInfo != keyInfo) {
			NotificationChain msgs = null;
			if (keyInfo != null)
				msgs = ((InternalEObject)keyInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmldsigPackage.SIGNATURE_TYPE__KEY_INFO, null, msgs);
			if (newKeyInfo != null)
				msgs = ((InternalEObject)newKeyInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XmldsigPackage.SIGNATURE_TYPE__KEY_INFO, null, msgs);
			msgs = basicSetKeyInfo(newKeyInfo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.SIGNATURE_TYPE__KEY_INFO, newKeyInfo, newKeyInfo));
	}
	...
	public EList<ObjectType> getObject() {
		if (object == null) {
			object = new EObjectContainmentEList<ObjectType>(ObjectType.class, this, XmldsigPackage.SIGNATURE_TYPE__OBJECT);
		}
		return object;
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.SIGNATURE_TYPE__ID, oldId, id));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case XmldsigPackage.SIGNATURE_TYPE__SIGNATURE_VALUE:
				return SIGNATURE_VALUE_EDEFAULT == null ? signatureValue != null : !SIGNATURE_VALUE_EDEFAULT.equals(signatureValue);
			case XmldsigPackage.SIGNATURE_TYPE__KEY_INFO:
				return keyInfo != null;
			case XmldsigPackage.SIGNATURE_TYPE__OBJECT:
