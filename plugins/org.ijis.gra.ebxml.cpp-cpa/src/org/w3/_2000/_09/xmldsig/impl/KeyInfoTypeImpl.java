...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Key Info Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.w3._2000._09.xmldsig.impl.KeyInfoTypeImpl#getRetrievalMethod <em>Retrieval Method</em>}</li>
 ...
 * @generated
 */
public class KeyInfoTypeImpl extends MinimalEObjectImpl.Container implements KeyInfoType {
	/**
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, XmldsigPackage.KEY_INFO_TYPE__GROUP);
		}
		return group;
	}
	...
	public FeatureMap getAny() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(XmldsigPackage.Literals.KEY_INFO_TYPE__ANY);
	}
	 ...
	 * @generated
	 */
	public EList<String> getSPKIData() {
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.KEY_INFO_TYPE__ID, oldId, id));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case XmldsigPackage.KEY_INFO_TYPE__SPKI_DATA:
				getSPKIData().clear();
				getSPKIData().addAll((Collection<? extends String>)newValue);
				return;
			case XmldsigPackage.KEY_INFO_TYPE__MGMT_DATA:
				getMgmtData().clear();
