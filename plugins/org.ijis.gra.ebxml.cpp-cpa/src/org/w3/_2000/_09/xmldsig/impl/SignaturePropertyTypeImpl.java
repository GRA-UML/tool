...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Signature Property Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class SignaturePropertyTypeImpl extends MinimalEObjectImpl.Container implements SignaturePropertyType {
	/**
	...
	public FeatureMap getGroup() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(XmldsigPackage.Literals.SIGNATURE_PROPERTY_TYPE__GROUP);
	}
	...
	public FeatureMap getAny() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(XmldsigPackage.Literals.SIGNATURE_PROPERTY_TYPE__ANY);
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.SIGNATURE_PROPERTY_TYPE__ID, oldId, id));
	}
	...
	public void setTarget(String newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.SIGNATURE_PROPERTY_TYPE__TARGET, oldTarget, target));
	}
