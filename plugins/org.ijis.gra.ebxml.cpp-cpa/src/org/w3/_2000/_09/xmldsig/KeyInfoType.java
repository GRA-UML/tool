 ...
 * @model extendedMetaData="name='KeyInfo_._type' kind='elementOnly'"
 * @generated
 */
public interface KeyInfoType extends EObject {
	 ...
	 *        extendedMetaData="kind='element' name='KeyName' namespace='##targetNamespace' group='#group:0'"
	 * @generated
	 */
	 ...
	 *        extendedMetaData="kind='element' name='KeyValue' namespace='##targetNamespace' group='#group:0'"
	 * @generated
	 */
	 ...
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='RetrievalMethod' namespace='##targetNamespace' group='#group:0'"
	 * @generated
	 */
	 ...
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='X509Data' namespace='##targetNamespace' group='#group:0'"
	 * @generated
	 */
	 ...
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='PGPData' namespace='##targetNamespace' group='#group:0'"
	 * @generated
	 */
	EList<PGPDataType> getPGPData();

	/**
	 * Returns the value of the '<em><b>SPKI Data</b></em>' attribute list.
	 * The list contents are of type {@link java.lang.String}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>SPKI Data</em>' attribute list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>SPKI Data</em>' attribute list.
	 * @see org.w3._2000._09.xmldsig.XmldsigPackage#getKeyInfoType_SPKIData()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='SPKIData' namespace='##targetNamespace' group='#group:0'"
	 * @generated
	 */
	EList<String> getSPKIData();
	 ...
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='MgmtData' namespace='##targetNamespace' group='#group:0'"
	 * @generated
	 */
