 ...
 *   <li>{@link org.w3._2000._09.xmldsig.impl.ReferenceTypeImpl#getDigestMethod <em>Digest Method</em>}</li>
...
public class ReferenceTypeImpl extends MinimalEObjectImpl.Container implements ReferenceType {
	...
	public NotificationChain basicSetTransforms(TransformsType newTransforms, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmldsigPackage.REFERENCE_TYPE__TRANSFORMS, oldTransforms, newTransforms);
	...
	public void setTransforms(TransformsType newTransforms) {
		if (newTransforms != transforms) {
			...
			if (transforms != null)
				msgs = ((InternalEObject)transforms).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmldsigPackage.REFERENCE_TYPE__TRANSFORMS, null, msgs);
			if (newTransforms != null)
				msgs = ((InternalEObject)newTransforms).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XmldsigPackage.REFERENCE_TYPE__TRANSFORMS, null, msgs);
			msgs = basicSetTransforms(newTransforms, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.REFERENCE_TYPE__TRANSFORMS, newTransforms, newTransforms));
	}
	...
	public NotificationChain basicSetDigestMethod(DigestMethodType newDigestMethod, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmldsigPackage.REFERENCE_TYPE__DIGEST_METHOD, oldDigestMethod, newDigestMethod);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDigestMethod(DigestMethodType newDigestMethod) {
		if (newDigestMethod != digestMethod) {
			...
			if (digestMethod != null)
				msgs = ((InternalEObject)digestMethod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmldsigPackage.REFERENCE_TYPE__DIGEST_METHOD, null, msgs);
			if (newDigestMethod != null)
				msgs = ((InternalEObject)newDigestMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XmldsigPackage.REFERENCE_TYPE__DIGEST_METHOD, null, msgs);
			msgs = basicSetDigestMethod(newDigestMethod, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.REFERENCE_TYPE__DIGEST_METHOD, newDigestMethod, newDigestMethod));
	}
	...
	public void setDigestValue(byte[] newDigestValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.REFERENCE_TYPE__DIGEST_VALUE, oldDigestValue, digestValue));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.REFERENCE_TYPE__ID, oldId, id));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.REFERENCE_TYPE__TYPE, oldType, type));
	}
	...
	public void setURI(String newURI) {
		...
		uRI = newURI;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.REFERENCE_TYPE__URI, oldURI, uRI));
	}
