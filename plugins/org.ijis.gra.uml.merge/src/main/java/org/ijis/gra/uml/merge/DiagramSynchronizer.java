...
import static org.ijis.gra.uml.papyrus.preferences.PreferenceConstants.P_CLASS_DIAGRAM_COLUMNS;
import static org.ijis.gra.uml.papyrus.preferences.PreferenceConstants.P_CLASS_DIAGRAM_COLUMN_WIDTH;
import static org.ijis.gra.uml.papyrus.preferences.PreferenceConstants.P_CLASS_DIAGRAM_ELEMENT_WIDTH;
import static org.ijis.gra.uml.papyrus.preferences.PreferenceConstants.P_CLASS_DIAGRAM_VERTICAL_PADDING;
import static org.ijis.gra.uml.papyrus.util.DiagramExt.createAClassDiagram;
import static org.ijis.gra.uml.papyrus.util.DiagramExt.createAComponentDiagram;
import static org.ijis.gra.uml.papyrus.util.DiagramExt.createAPackageDiagram;
import static org.ijis.gra.uml.papyrus.util.DiagramExt.createAnHyperLink;
import static org.ijis.gra.uml.papyrus.util.DiagramExt.getTheAttributeCompartment;
import static org.ijis.gra.uml.papyrus.util.DiagramExt.getTheClassDiagramKind;
import static org.ijis.gra.uml.papyrus.util.DiagramExt.getTheClassDiagramPreferencesHint;
import static org.ijis.gra.uml.papyrus.util.DiagramExt.getTheComponentDiagramKind;
import static org.ijis.gra.uml.papyrus.util.DiagramExt.getTheComponentDiagramPreferencesHint;
import static org.ijis.gra.uml.papyrus.util.DiagramExt.getThePackageDiagramKind;
import static org.ijis.gra.uml.papyrus.util.DiagramExt.getThePackageDiagramPreferencesHint;
import static org.ijis.gra.uml.util.UMLExt.getGeneral;
import static org.ijis.gra.uml.util.UMLExt.getGeneralizations;
import static org.ijis.gra.uml.util.UMLExt.getNestedPackages;
import static org.ijis.gra.uml.util.UMLExt.getOwnedAttributes;
import static org.ijis.gra.uml.util.UMLExt.getPackagedElements;
import static org.ijis.gra.uml.util.UMLExt.getSpecific;
...
public class DiagramSynchronizer {
    ...
    private abstract class DiagramNodeFactory extends NodeFactory {
        ...
        private int getPreference(final String name) {
            return org.ijis.gra.uml.papyrus.Activator.INSTANCE.getIntPreference(name);
        }
