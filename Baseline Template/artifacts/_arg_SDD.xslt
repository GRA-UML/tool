    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body lang="EN-US" style="float:none;">
            <div class="CoverPageSection" style="float:none;overflow:visible;">
                ...
                <p class="MsoNormal">
                    <b><span class="FontType TitleMain">Service Description</span></b>
                </p> <br/>      
                <p class="MsoNormal">
            ...
            <div class="ContentSection" >
                ...
                <p> <a href="#_Toc387846683"> <span class="FontType TableOfContents">2.  &#160; &#160; Service Overview</span> </a> </p>
                <p> <a href="#_Toc387846684"> <span class="FontType TableOfContents">2.1 &#160; &#160; Purpose</span> </a> </p>
                <p> <a href="#_Toc387846685"> <span class="FontType TableOfContents">2.2 &#160; &#160; Scope</span> </a> </p>
                <p> <a href="#_Toc387846686"> <span class="FontType TableOfContents">2.3 &#160; &#160; Capabilities</span> </a> </p>
                <p> <a href="#_Toc387846687"> <span class="FontType TableOfContents">2.4 &#160; &#160; Real-World Effects</span> </a> </p>
                <p> <a href="#_Toc387846688"> <span class="FontType TableOfContents">2.5 &#160; &#160; Summary</span> </a> </p>
                <p> <a href="#_Toc387846689"> <span class="FontType TableOfContents">2.6 &#160; &#160; Description</span> </a> </p>
                <p> <a href="#_Toc387846690"> <span class="FontType TableOfContents">2.7 &#160; &#160; Security Classification</span> </a> </p>
                <p> <a href="#_Toc387846691"> <span class="FontType TableOfContents">2.8 &#160; &#160; Service Specification Package Version</span> </a> </p>
                <p> <a href="#_Toc387846692"> <span class="FontType TableOfContents">3.  &#160; &#160; Business Scenarios</span> </a> </p>
                <p> <a href="#_Toc387846693"> <span class="FontType TableOfContents">4.  &#160; &#160; Service Interoperability Requirements</span> </a> </p>
                <p> <a href="#_Toc387846694"> <span class="FontType TableOfContents">4.1 &#160; &#160; Service Interaction Requirements</span> </a> </p>
                <p> <a href="#_Toc387846695"> <span class="FontType TableOfContents">4.2 &#160; &#160; Service Assumptions</span> </a> </p>
                <p> <a href="#_Toc387846696"> <span class="FontType TableOfContents">4.3 &#160; &#160; Service Dependencies</span> </a> </p>
                <p> <a href="#_Toc387846697"> <span class="FontType TableOfContents">4.4 &#160; &#160; Execution Context</span> </a> </p>
                <p> <a href="#_Toc387846698"> <span class="FontType TableOfContents">4.5 &#160; &#160; Policies and Contracts</span> </a> </p>
                <p> <a href="#_Toc387846699"> <span class="FontType TableOfContents">4.6 &#160; &#160; Security</span> </a> </p>
                <p> <a href="#_Toc387846700"> <span class="FontType TableOfContents">4.7 &#160; &#160; Privacy</span> </a> </p>
                <p> <a href="#_Toc387846701"> <span class="FontType TableOfContents">4.8 &#160; &#160; Other Requirements</span> </a> </p>
                <p> <a href="#_Toc387846702"> <span class="FontType TableOfContents">5.  &#160; &#160; Additional Information</span> </a> </p>
                <p> <a href="#_Toc387846703"> <span class="FontType TableOfContents">6.  &#160; &#160; Service Model</span> </a> </p>
                <p> <a href="#_Toc387846704"> <span class="FontType TableOfContents">6.1 &#160; &#160; Information Model</span> </a> </p>
                <p> <a href="#_Toc387846705"> <span class="FontType TableOfContents">6.1.1 &#160; &#160; IEPD Reference</span> </a> </p>
                <p> <a href="#_Toc387846706"> <span class="FontType TableOfContents">6.1.2 &#160; &#160; Data Inputs</span> </a> </p>
                <p> <a href="#_Toc387846707"> <span class="FontType TableOfContents">6.1.3 &#160; &#160; Data Outputs</span> </a> </p>
                <p> <a href="#_Toc387846708"> <span class="FontType TableOfContents">6.1.4 &#160; &#160; Data Provenance</span> </a> </p>
                <p> <a href="#_Toc387846709"> <span class="FontType TableOfContents">6.2   &#160; &#160; Behavior Model</span> </a> </p>
                <p> <a href="#_Toc387846710"> <span class="FontType TableOfContents">6.2.1 &#160; &#160; Action Model</span> </a> </p>
                <p> <a href="#_Toc387846711"> <span class="FontType TableOfContents">6.2.2 &#160; &#160; Process Model</span> </a> </p>
                ...
                <p class="MsoNormalText"><span class="FontType NormalText">
                        This Service Description Document describes information about all aspects of
                        the <xsl:value-of select="foo:ReturnValue('$_arg_ServiceName_',//SAN:ServiceDescription/SAN:ServiceFullNameText)"/> (<xsl:value-of select="foo:ReturnValue('$_arg_ServiceAbbreviation_',//SAN:ServiceDescription/SAN:ServiceNameAbbreviationText)"/>) service which are not
                        directly tied to the physical implementation.</span></p>
                <p class="MsoNormalText"><span class="FontType NormalText">
                ...
                <h1><a id="_Toc387846683"><span class="FontType Heading1">2. &#160; &#160; Service Overview</span></a></h1>            
                <h2><a id="_Toc387846684"><span class="FontType Heading2">2.1 &#160; &#160; Purpose</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText">
                        The purpose of this service is to support the establishment and operation of
                        automated <xsl:value-of select="foo:ReturnValue('$_arg_ServiceName_',//SAN:ServiceDescription/SAN:ServiceFullNameText)"/> (<xsl:value-of select="foo:ReturnValue('$_arg_ServiceAbbreviation_',//SAN:ServiceDescription/SAN:ServiceNameAbbreviationText)"/>) service
                        capabilities.  This document describes the basic functions comprising the
                        information sharing process.  This service specification enables interoperable
                        information exchange between system implementations.</span></p>
                
                <h2><a id="_Toc387846685"><span class="FontType Heading2">2.2 &#160; &#160; Scope</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_Scope_',//SAN:ServiceDescription/SAN:ServiceScopeDescription/SAN:Description)"/></span></p>
                
                <h2><a id="_Toc387846686"><span class="FontType Heading2">2.3 &#160; &#160; Capabilities</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_Capabilities_',//SAN:ServiceDescription/SAN:ServiceCapabilities/SAN:CapabilityDescriptionText)"/></span></p>
                
                <h2><a id="_Toc387846687"><span class="FontType Heading2">2.4 &#160; &#160; Real-World Effects</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:for-each select="//SAN:ServiceDescription/SAN:RealWorldEffect/SAN:RealWorldEffectDescriptionText">
			    <li class="Bullet"><xsl:value-of select="foo:ReturnValue('$_arg_RealWorldEffects_',text())"/></li></xsl:for-each></span></p>
                
                <h2><a id="_Toc387846688"><span class="FontType Heading2">2.5 &#160; &#160; Summary</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_ServiceSummary_',//SAN:ServiceDescription/SAN:ServiceDescriptionSummaryText)"/></span></p>
                
                <h2><a id="_Toc387846689"><span class="FontType Heading2">2.6 &#160; &#160; Description</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_Description_',//SAN:ServiceDescription/SAN:ServicePurpose/SAN:Description)"/></span></p>
                
                <h2><a id="_Toc387846690"><span class="FontType Heading2">2.7 &#160; &#160; Security Classification</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_SecurityClassification_',//SAN:ServiceDescription/SAN:ServiceSecurityClassification/SAN:SecurityClassificationText)"/></span></p>
                
                <h2><a id="_Toc387846691"><span class="FontType Heading2">2.8 &#160; &#160; Service Specification Package Version</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText">This service specification is built based on version <xsl:value-of select="foo:ReturnValue('$_arg_SSPVersion_',//SAN:ServiceDescription/SAN:ServiceInterface[1]/SANWSDL:ServiceInteractionProfile/SAN:SIPVersion)"/> of the GRA Service Speciatication Package (SSP)</span></p>
    
                <br style="page-break-before:always" />
                <h1><a id="_Toc387846692"><span class="FontType Heading1">3. &#160; &#160; Business Scenarios</span></a></h1>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_BusinessScenarios_',//SAN:ServiceDescription/SAN:BusinessScenarios)"/></span></p>
                
                <br style="page-break-before:always" />
                <h1><a id="_Toc387846693"><span class="FontType Heading1">4. &#160; &#160; Service Interoperability Requirements</span></a></h1>            
                <h2><a id="_Toc387846694"><span class="FontType Heading2">4.1 &#160; &#160; Service Interaction Requirements</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText">
                ...
                <h2><a id="_Toc387846695"><span class="FontType Heading2">4.2 &#160; &#160; Service Assumptions</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_ServiceAssumptions_',//SAN:ServiceDescription/SAN:ServiceAssumptions)"/></span></p>
                
                <h2><a id="_Toc387846696"><span class="FontType Heading2">4.3 &#160; &#160; Service Dependencies</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_ServiceDependencies_',//SAN:ServiceDescription/SAN:ServiceDependencies)"/></span></p>
                
                <h2><a id="_Toc387846697"><span class="FontType Heading2">4.4 &#160; &#160; Execution Context</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_ExecutionContext_',//SAN:ServiceDescription/SAN:ExecutionContext)"/></span></p>
                
                <h2><a id="_Toc387846698"><span class="FontType Heading2">4.5 &#160; &#160; Policies and Contracts</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_PoliciesContracts_',//SAN:ServiceDescription/SAN:PoliciesContracts)"/></span></p>
                
                <h2><a id="_Toc387846699"><span class="FontType Heading2">4.6 &#160; &#160; Security</span></a></h2>
                ...
                <h2><a id="_Toc387846700"><span class="FontType Heading2">4.7 &#160; &#160; Privacy</span></a></h2>
                ...
                <h2><a id="_Toc387846701"><span class="FontType Heading2">4.8 &#160; &#160; Other Requirements</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_OtherRequirements_',//SAN:ServiceDescription/SAN:OtherRequirements)"/></span></p>
       
                <br style="page-break-before:always" />
                <h1><a id="_Toc387846702"><span class="FontType Heading1">5. &#160; &#160; Additional Information</span></a></h1>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_AdditionalInformation_',//SAN:ServiceDescription/SAN:AdditionalInformation)"/></span></p>
                
                <br style="page-break-before:always" />
                <h1><a id="_Toc387846703"><span class="FontType Heading1">6. &#160; &#160; Service Model</span></a></h1>
                <h2><a id="_Toc387846704"> <span class="FontType Heading2">6.1 &#160; &#160; Information Model</span></a></h2>

                <h2><a id="_Toc387846705"> <span class="FontType Heading3">6.1.1 &#160; &#160; IEPD Reference</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText">This used the <xsl:value-of select="foo:ReturnValue('$_arg_IEPDReference_',//SAN:ServiceDescription/SAN:IEPDReference/SAN:IEPDName)"/> Information Exchange Package Documentation (IEPD) for all messages exchanged by the service. The IEPD is included in its entirety in the artifacts/service model/information model folder of the Service Specification Package.</span></p>
                
                <h2><a id="_Toc387846706"> <span class="FontType Heading3">6.1.2 &#160; &#160; Data Inputs</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_DataInputs_',//SAN:ServiceDescription/SAN:DataInputs)"/></span></p>
                
                <h2><a id="_Toc387846707"> <span class="FontType Heading3">6.1.3 &#160; &#160; Data Outputs</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_DataOutputs_',//SAN:ServiceDescription/SAN:DataOutputs)"/></span></p>
                
                <h2><a id="_Toc387846708"> <span class="FontType Heading3">6.1.4 &#160; &#160; Data Provenance</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_DataProvenance_',//SAN:ServiceDescription/SAN:DataProvenance)"/></span></p>
                
                <h2><a id="_Toc387846709"> <span class="FontType Heading2">6.2   &#160; &#160; Behavior Model</span></a></h2>
                
                <h2><a id="_Toc387846710"> <span class="FontType Heading3">6.2.1 &#160; &#160; Action Model</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_ActionModel_',//SAN:ServiceDescription/SAN:ActionModel)"/></span></p>
                
                <h2><a id="_Toc387846711"> <span class="FontType Heading3">6.2.2 &#160; &#160; Process Model</span></a></h2>
                <p class="MsoNormalText"><span class="FontType NormalText"><xsl:value-of select="foo:ReturnValue('$_arg_ProcessModel_',//SAN:ServiceDescription/SAN:ProcessModel)"/></span></p>
                
                <br style="page-break-before:always" />
                <h2><a id="_Toc387846712"> <span class="FontType Heading1">Appendix A &#160; &#160; References</span></a></h2>
