<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:graa="http://ijis.org/GRA/Annotations">
	...
	<xsl:template match="/">
		...
		<xsl:variable name="fileLocation" select="concat((graa:ServiceDescription/@serviceNameAbbreviationText, 'x')[1], '_SDD_v_', $versionInfo, '.xhtml')"/>	
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body lang="EN-US">
				...
				<div class="ContentSection">
					...
					<p class="MsoNormalText">
						<span class="FontType NormalText">
							<xsl:if test="/graa:ServiceDescription/servicePurpose[1]/@documentation">
								<xsl:value-of select="/graa:ServiceDescription[1]/servicePurpose/@documentation"/>
							</xsl:if>
							<xsl:if test="not(/graa:ServiceDescription[1]/servicePurpose/@documentation)">
					...
					<p class="MsoNormalText">
						<span class="FontType NormalText">
							<xsl:value-of disable-output-escaping="yes"
								select="graa:ReturnValue('$_arg_Description_',/graa:ServiceDescription[1]/@documentation)"/>
						</span>
					</p>
									...
									<xsl:for-each select="interface[1]/operation">
										<xsl:for-each select="parameter">
											<xsl:if test="@use = 'in'">
												...
												<xsl:if test="message/@documentation">
													<tr style="height:.3in">
														<td class="tDataTable tDataTableRowAlt" colspan="3"  width="200">
															<span class="FontType tDataTableText"  width="200">
																<xsl:value-of select="message/@name"/> Description: <xsl:value-of select="message/@documentation"/>
															</span>
														</td>
													</tr>
												</xsl:if>
										...
										<xsl:if test="@documentation">
											<tr style="height:.3in">
												<td class="tDataTable tDataTableRowAlt" colspan="2">
													<span class="FontType tDataTableText">
														<b>Description: </b><xsl:value-of select="@documentation"/>
													</span>
												</td>
											</tr>
										</xsl:if>
