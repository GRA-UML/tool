		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body lang="EN-US" style="float:none;">
				...
				<div class="ContentSection">
					...
					<p class="MsoNormalText">
						<span class="FontType NormalText">
							<xsl:if test="/graa:ServiceDescription/serviceLevelAgreement/applicablePolicy/@automatedAgreementIndicator = 'true'">
								<xsl:value-of disable-output-escaping="yes"
									select="graa:ReturnValue('$_arg_Policies_',/graa:ServiceDescription[1]/serviceLevelAgreement/applicablePolicy/@documentation)" />
							</xsl:if>
							<xsl:if test="not(/graa:ServiceDescription/serviceLevelAgreement/applicablePolicy/@automatedAgreementIndicator = 'true')">
								<xsl:value-of disable-output-escaping="yes" select="graa:ReturnValue('$_arg_Policies_','No automated polices have been identified at this time.')" />
							</xsl:if>
						</span>
					</p>
					...
					<p class="MsoNormalText">
						<span class="FontType NormalText">							
							<xsl:if test="/graa:ServiceDescription/serviceLevelAgreement/applicableContract/@automatedAgreementIndicator = 'true'">
								<xsl:value-of disable-output-escaping="yes"
									select="graa:ReturnValue('$_arg_AutomatedServiceContracts_',/graa:ServiceDescription[1]/serviceLevelAgreement/applicableContract/@documentation)" />
							</xsl:if>
							<xsl:if test="not(/graa:ServiceDescription/serviceLevelAgreement/applicableContract/@automatedAgreementIndicator = 'true')">
								<xsl:value-of disable-output-escaping="yes" select="graa:ReturnValue('$_arg_AutomatedServiceContracts_','Web Services Description Language (WSDL) defines an automated service contract. No automated service contracts exist beyond those specified in the WSDLs.')" />
							</xsl:if>							
						</span>
					</p>
					...
					<h1>
						<a id="_Toc387846707">
							<span class="FontType Heading2">
								<xsl:text>7.3 &#160; &#160; Non-automated Service Policies and Contracts</xsl:text>
							</span>
						</a>
					</h1>
					<p class="MsoNormalText">
						<span class="FontType NormalText">
								<xsl:if test="not(/graa:ServiceDescription/serviceLevelAgreement/applicablePolicy/@automatedAgreementIndicator = 'true')">
									<xsl:value-of disable-output-escaping="yes"
										select="graa:ReturnValue('$_arg_Policies_',/graa:ServiceDescription[1]/serviceLevelAgreement/applicablePolicy/@documentation, 'No non-automated service contracts have been identified at this time.')" />
								</xsl:if>
						</span>
					</p>
					...
					<p class="MsoNormalText">
						<span class="FontType NormalText">
							<xsl:value-of disable-output-escaping="yes"
								select="graa:ReturnValue('$_arg_UmbrellaAgreements_',/graa:ServiceDescription[1]/serviceLevelAgreement[1]/umbrellaAgreement/@documentation, 'No umbrella agreements have been identified at this time.')"
							/>
						</span>
					</p>
