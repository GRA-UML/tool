					...
					<div class="resource" style="width:7.0in;">
						<ul>
							<xsl:for-each select="serviceInterface">		
								<li>
									<a>
										<xsl:variable name="wsdlFileLocation" select="lower-case(concat('./schemas/', (serviceInteractionProfile/@sipName,'SIP_WS_')[1], (serviceInteractionProfile/@sipVersion,'1.3')[1], '/', (@serviceInterfaceNameAbbreviationText,'webservice')[1], '.wsdl'))"/>	
										<xsl:attribute name="href" select='$wsdlFileLocation' />
